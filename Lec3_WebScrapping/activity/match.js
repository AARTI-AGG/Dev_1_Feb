...
// let path = "https://www.espncricinfo.com/series/ipl-2020-21-1210595/delhi-capitals-vs-mumbai-indians-final-1237181/full-scorecard";
...
function checkTeamFolder(teamPath){
  ...
  function updateBatsmanFile(batsmanPath , opponentTeam , runs , balls , fours , sixes , strikeRate){
    ...
    // Data will come in stringified form so we will convert back to object form
  ...
  function createBatsmanFile(batsmanPath , opponentTeam , runs , balls , fours , sixes , strikeRate){
    // "./IPL/Mumbai Indians/batsmanname.json"
    let batsmanFile = [];
    let inning = {
      Opponent : opponentTeam ,
      Runs : runs ,
